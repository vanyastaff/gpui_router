...
///
/// ```
/// use gpui_router::NavigationRequest;
///
...
impl GlobalRouter {
    ...
    /// # Example
    /// ```ignore
    /// use gpui_router::{GlobalRouter, Transition};
    ///
...
///
/// ```ignore
/// use gpui_router::{init_router, Route};
///
/// fn main() {
///     App::new().run(|cx| {
...
impl Navigator {
    ...
    ///
    /// ```ignore
    /// use gpui_router::{Navigator, RouteParams};
    ///
    ...
    /// # Example
    /// ```ignore
    /// use gpui_router::{Navigator, Transition};
    ///
    ...
    /// # Example
    /// ```ignore
    /// use gpui_router::{Navigator, RouteParams, Transition};
    ///
    /// let mut params = RouteParams::new();
